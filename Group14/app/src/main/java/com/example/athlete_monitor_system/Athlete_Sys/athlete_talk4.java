...
public class athlete_talk4 extends AppCompatActivity {
    private Button send;
    private MultiAutoCompleteTextView athlete_talk;
    private TextView coach_send;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("athlete_message4"),
            myRef = FirebaseDatabase.getInstance().getReference().child("coach_message4");
    String cache = "";
