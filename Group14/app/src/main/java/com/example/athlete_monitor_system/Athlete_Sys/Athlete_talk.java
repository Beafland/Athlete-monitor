...
public class Athlete_talk extends AppCompatActivity {
    private Button send;
    private MultiAutoCompleteTextView athlete_talk;
    private TextView coach_send;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("athlete_message"),
            myRef = FirebaseDatabase.getInstance().getReference().child("coach_message");
    String cache = "";
