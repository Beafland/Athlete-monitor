...
public class talk4 extends AppCompatActivity {
    private Button send;
    private MultiAutoCompleteTextView coach_talk;
    private TextView athlete_send, sender;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("coach_message4"),
            myRef = FirebaseDatabase.getInstance().getReference().child("athlete_message4");
    String cache = "";
