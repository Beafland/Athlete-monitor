...
public class talk3 extends AppCompatActivity {
    private Button send;
    private MultiAutoCompleteTextView coach_talk;
    private TextView athlete_send, sender;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("coach_message3"),
            myRef = FirebaseDatabase.getInstance().getReference().child("athlete_message3");
    String cache = "";
