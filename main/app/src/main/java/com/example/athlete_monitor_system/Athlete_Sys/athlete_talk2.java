...
public class athlete_talk2 extends AppCompatActivity {
    private Button send;
    private MultiAutoCompleteTextView athlete_talk;
    private TextView coach_send;
    private DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("athlete_message2"),
            myRef = FirebaseDatabase.getInstance().getReference().child("coach_message2");
    String cache = "";
